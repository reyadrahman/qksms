...
/**
 * Provide a kt extension function to make this more intuitive to use
 */
fun SubscriptionManager.activeSubscriptionObservable(): ActiveSubscriptionObservable {
    return ActiveSubscriptionObservable(this)
}